...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Creators Lab" },
      { name: "description", content: "Creators Lab is a student creator campaign portal for submitting videos and earning UPI payouts." },
      { name: "author", content: "Testbook" },
      { property: "og:site_name", content: "Creators Lab" },
      { property: "og:title", content: "Creators Lab" },
      { property: "og:description", content: "Creators Lab is a student creator campaign portal for submitting videos and earning UPI payouts." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://creatorlabs.testbook.com/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Testbookdotcom" },
      { name: "twitter:title", content: "Creators Lab" },
      { name: "twitter:description", content: "Creators Lab is a student creator campaign portal for submitting videos and earning UPI payouts." },
    ],
    links: [
